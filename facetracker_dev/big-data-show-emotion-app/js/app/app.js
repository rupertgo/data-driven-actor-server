$(document).ready( function($) {
	...
	app.selectors.video.attr('height',window.innerHeight-40);
	...
	app.setup = function() {
		...
		window.setInterval(app.updateFPS,1000);
	...
	//	stroke(0);
		...
		overlayCC.strokeStyle = "#4481BA";
		//fill(255);
		rect(positions[44][0], positions[44][1], rectSize, rectSize); // Draw gray rect using CENTER mode
		rect(positions[23][0], positions[23][1], rectSize, rectSize);
		rect(positions[33][0], positions[33][1], rectSize, rectSize);
		rect(positions[34][0], positions[34][1], rectSize, rectSize);
		rect(positions[40][0], positions[40][1], rectSize, rectSize);
		rect(positions[28][0], positions[28][1], rectSize, rectSize);
		rect(positions[50][0], positions[50][1], rectSize, rectSize);
		rect(positions[55][0], positions[55][1], rectSize, rectSize);
		rect(positions[3][0], positions[3][1], rectSize, rectSize);
		rect(positions[11][0], positions[11][1], rectSize, rectSize);
		rect(positions[51][0], positions[51][1], rectSize, rectSize);
		rect(positions[25][0], positions[25][1], rectSize, rectSize);
		rect(positions[30][0], positions[30][1], rectSize, rectSize);
		rect(positions[0][0], positions[0][1], rectSize, rectSize);
